...
## Project Structure
    ...
    ├── testapiautosetting_127322  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127322`
...
2. Clone this repo and `cd testapiautosetting_127322`
